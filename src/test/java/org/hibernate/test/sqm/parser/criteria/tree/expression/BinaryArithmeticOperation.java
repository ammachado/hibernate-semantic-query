...
//		throw new NotYetImplementedException();
		return visitor.visitArithmetic(mapOperation(this.operator), this.lhs, this.rhs );
	}
	...
	private  BinaryArithmeticExpression.Operation mapOperation(Operation operator){
		switch(operator){
			case ADD:
			...
			case MOD:
				return BinaryArithmeticExpression.Operation.MODULO;
			default:
				return  null;
		}
